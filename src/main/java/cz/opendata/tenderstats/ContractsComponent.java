...
public class ContractsComponent extends AbstractComponent {
	...
	private JsonObject getPublicContract(String contractURI) throws PCFappException {		
		return modelContract.getPublicContractAsJson(modelContract.getPublicContract(contractURI), contractURI);
	}

	private JsonObject getPrivateContract(String contractURI, String graphURI) throws PCFappException {
