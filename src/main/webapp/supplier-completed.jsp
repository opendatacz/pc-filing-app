...
<html>
    ...
    <body>
                    ...
                    <table class="table table-striped table-bordered" style="display:none;" id="contractTable">
                        <thead>
                            <tr>
                                ...
                                <th><fmt:message key="completed" bundle="${cons}" /></th>
        ...
        <script type="text/javascript">
                                ...
                                var tableAddress = "PCFilingApp?action=table&tableName=CompletedTenders";
                                ...
                                function fillTable() {
                                    ...
                                    $.each(
                                            ...
                                            function(i, data) {
                                                ...
                                                // Completed
                                                newCompleted = $('<td>').append(formatDate(data.completed)).appendTo(newRow);
