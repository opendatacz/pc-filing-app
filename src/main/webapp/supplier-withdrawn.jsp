...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span10">	        
                    ...
                    <h3 style="margin-bottom: 20px;"><fmt:message key="withdrawn.title" /></h3>
                    ...
                    <table class="table table-striped table-bordered" style="display:none;" id="contractTable">
                        <thead>
                            <tr>
                                ...
                                <th><fmt:message key="withdrawn" bundle="${cons}" /></th>
        ...
        <script type="text/javascript">
                                ...
                                var tableAddress = "PCFilingApp?action=table&tableName=WithdrawnTenders";
                                ...
                                function fillTable() {
                                    ...
                                    $.each(
                                            ...
                                            function(i, data) {
                                                ...
                                                // Withdrawn
                                                newWithdrawn = $('<td>').append(formatDate(data.withdrawn)).appendTo(newRow);
