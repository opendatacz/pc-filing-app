...
<html>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span10">	        
                    ...
                    <h3 style="margin-bottom: 20px;"><fmt:message key="rejected.title" /></h3>
                    ...
                    <table class="table table-striped table-bordered" style="display:none;" id="contractTable">
                        <thead>
                            <tr>
                                ...
                                <th><fmt:message key="rejected" bundle="${cons}" /></th>
	...
	<script src="js/cpv-codes-<c:out value="${pageContext.request.locale.language}" />.js"></script>         
        ...
        <script type="text/javascript">
                                ...
                                var tableAddress = "PCFilingApp?action=table&tableName=RejectedTenders";
                                ...
                                function fillTable() {
                                    ...
                                    $.each(
                                            ...
                                            function(i, data) {
                                                ...
                                                // Rejected
                                                newRejected = $('<td>').append(formatDate(data.rejected)).appendTo(newRow);
