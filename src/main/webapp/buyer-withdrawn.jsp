...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span8">
                    ...
                    <h4><fmt:message key="withdrawn.title" /></h4>
        ...
        <script type="text/javascript">
                                        ...
                                        var tableAddress = "PCFilingApp?action=table&tableName=WithdrawnCalls";
                                        ...
                                        function fillTable() {
                                            ...
                                            $.each(
                                                    ...
                                                    function(i, data) {
                                                        ...
                                                        newWithdraw.click(function() {
                                                            copyEvent(data.contractURI);
                                                        });
