...
<html>
                ...
                <div class="span10">	        
                    ...
                    <div class="alert hide" id="userHelper">
                      <button class="close"
                        ...
                        <fmt:message key="forcancelled.help" />
                    </div>
                    ...
                    <h3 style="margin-bottom: 20px;"><fmt:message key="forcancelled.title" /></h3>
                    ...
                    <table class="table table-striped table-bordered" style="display:none;" id="contractTable">
                        <thead>
                            <tr>
                                ...
                                <th><fmt:message key="cancelled" bundle="${cons}" /></th>
	...
	<script src="js/cpv-codes-<c:out value="${pageContext.request.locale.language}" />.js"></script>
        ...
        <script type="text/javascript">
                                ...
                                var tableAddress = "PCFilingApp?action=table&tableName=TendersForCancelled";
                                ...
                                function fillTable() {
                                    ...
                                    $.each(
                                            ...
                                            function(i, data) {
                                                ...
                                                // Cancelled
                                                newCancelled = $('<td>').append(formatDate(data.cancelled)).appendTo(newRow);
