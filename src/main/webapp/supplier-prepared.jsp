...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span10">	
                    ...
                    <h3 style="margin-bottom: 20px;"><fmt:message key="prepared.title" /></h3>
        ...
        <script type="text/javascript">
                                ...
                                var tableAddress = "PCFilingApp?action=table&tableName=PrivateTenders";
                                ...
                                function fillTable() {
                                    ...
                                    $.each(
                                            ...
                                            function(i, data) {
                                                ...
                                                // Submit
                                                newSubmit = $('<a>');
                                                newSubmit.attr('href', 'PCFilingApp?action=submitPrivateTender&forward=supplier-submitted.jsp&tenderURL=' + encodeURIComponent(data.tenderURI) + '&contractURL=' + encodeURIComponent(data.contractURI) + '&buyerURL=' + encodeURIComponent(data.buyerURI));
