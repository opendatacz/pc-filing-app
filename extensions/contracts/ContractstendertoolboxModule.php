...
class ContractstendertoolboxModule extends OntoWiki_Module
{
    ...
    {
        return "Public Contract App: Tender";
    }
    ...
    public function getContents()
    {
        ...
        $content = $this->render('contracts/module-tender', $data, 'data'); // 
        return $content;
    }
    ...
    public function shouldShow()
    {
        ...
        if (!($this->_owApp->getUser()->isAnonymousUser())) {
            ...
            foreach ($types as $type) {
                if ($type["uri"] === "http://purl.org/procurement/public-contracts#Tender") {
                    return true;
                }
            }
        } else
