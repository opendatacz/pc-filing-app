...
class ContractsbusinesstoolboxModule extends OntoWiki_Module
{
    ...
    {
        return "Public Contract App: Business Entity";
    }
    ...
    public function getContents()
    {
        ...
        $content = $this->render('contracts/module-business', $data, 'data'); // 
        return $content;
    }
